 ...
 * @author guigu
 */
public class AddBookView extends JPanel implements View{
    private Modele modele;
    
    public AddBookView(Modele modele){
        this.modele = modele;
        
        GridBagLayout layout = new GridBagLayout();
        this.setLayout(layout);
        
        JLabel title = new JLabel("Enregistrer livre");
        ...
        JButton validateButton = new JButton("Valider l'enregistrement");
